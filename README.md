...
- Go to the directory and open terminal
- Run `npm run start`
...
- Hit "Home Team", "Draw" or "Away Team" button to vote
...
This application is fully responsive and work well across different types of devices.
It stores data in a browser local storage to persist data across page reloads.
